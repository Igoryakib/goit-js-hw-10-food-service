parcelRequire = (function (e, r, t, n) {
  ...
  {
    Tk75: [function (require, module, exports) {}, {}],
    mA8c: [
    ...
    x9mp: [
      function (require, module, exports) {
        ...
        const e = n.default.template({
          1: function (n, l, e, a, r) {
            var t,
              c,
              o = null != l ? l : n.nullContext || {},
            ...
            return (
              ...
              u(
                typeof (c =
                  null != (c = p(e, 'image') || (null != l ? p(l, 'image') : l)) ? c : s) === i
                  ? c.call(o, {
                      name: 'image',
                      hash: {},
                      data: r,
                      loc: { start: { line: 5, column: 11 }, end: { line: 5, column: 20 } },
                    })
                  : c,
              ) +
              '"\r\n      alt="' +
              u(
                typeof (c =
                  null != (c = p(e, 'name') || (null != l ? p(l, 'name') : l)) ? c : s) === i
                  ? c.call(o, {
                      name: 'name',
                      hash: {},
                      data: r,
              ...
              u(
                typeof (c =
                  ...
                  ? c.call(o, {
                      ...
                      hash: {},
                      data: r,
                      loc: { start: { line: 10, column: 29 }, end: { line: 10, column: 37 } },
                    })
                  : c,
              ) +
              ...
              u(
                typeof (c =
                  null != (c = p(e, 'price') || (null != l ? p(l, 'price') : l)) ? c : s) === i
                  ? c.call(o, {
                      name: 'price',
                      hash: {},
                      data: r,
                      loc: { start: { line: 13, column: 8 }, end: { line: 13, column: 17 } },
                    })
                  : c,
              ) +
              '\r\n      </p>\r\n\r\n      <p class="card__descr">\r\n          ' +
              u(
                typeof (c =
                  null != (c = p(e, 'description') || (null != l ? p(l, 'description') : l))
                    ? c
                    : s) === i
                  ? c.call(o, {
                      name: 'description',
                      hash: {},
                      data: r,
                      loc: { start: { line: 17, column: 10 }, end: { line: 17, column: 25 } },
                    })
                  : c,
              ) +
              '\r\n      </p>\r\n      <ul class="tag-list">\r\n' +
              (null !=
              (t = p(e, 'each').call(o, null != l ? p(l, 'ingredients') : l, {
                name: 'each',
                hash: {},
                fn: n.program(2, r, 0),
                inverse: n.noop,
                data: r,
                loc: { start: { line: 20, column: 10 }, end: { line: 22, column: 17 } },
              }))
                ? t
                : '') +
              '      </ul>\r\n    </div>\r\n\r\n    <button class="card__button button">\r\n      <span class="material-icons button__icon"> shopping_cart </span>\r\n      В корзину\r\n    </button>\r\n  </div>\r\n</li>\r\n'
            );
          },
          2: function (n, l, e, a, r) {
            return (
          ...
          main: function (n, l, e, a, r) {
            ...
            return (
              ...
              (t = (
                ...
                inverse: n.noop,
                data: r,
                loc: { start: { line: 1, column: 0 }, end: { line: 32, column: 9 } },
              }))
                ? t
                : '') + '\r\n\r\n'
            );
    ...
    Focm: [
      function (require, module, exports) {
        ...
        var e = c(require('./menu.json')),
          t = c(require('./templates/itemsTemplate.hbs'));
        function c(e) {
          return e && e.__esModule ? e : { default: e };
        }
        const s = { LIGHT: 'light-theme', DARK: 'dark-theme' },
          o = document.querySelector('.theme-switch__toggle'),
          r = () => {
            if (
        ...
        const d = () => {
          o.checked ||
            (localStorage.setItem('theme', s.LIGHT),
            document.querySelector('body').classList.remove(`${s.DARK}`),
            document.querySelector('body').classList.add(`${s.LIGHT}`),
            (o.checked = !1)),
            o.checked &&
              (localStorage.setItem('theme', s.DARK),
              document.querySelector('body').classList.remove(`${s.LIGHT}`),
              document.querySelector('body').classList.add(`${s.DARK}`),
              (o.checked = !0));
        };
        o.addEventListener('change', d);
        const l = document.querySelector('.js-menu'),
          a = (0, t.default)(e.default);
        l.insertAdjacentHTML('beforeend', a);
      },
      {
        './sass/style.scss': 'Tk75',
        './menu.json': 'mA8c',
        './templates/itemsTemplate.hbs': 'x9mp',
      },
    ],
  },
  {},
...
//# sourceMappingURL=/goit-js-hw-10-food-service/src.ec0f6758.js.map
